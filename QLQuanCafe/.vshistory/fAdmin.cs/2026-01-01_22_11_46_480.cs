...
namespace QLQuanCafe
{
    public partial class fAdmin : Form
    {
        ...
        private void LoadGridViewFoodTable()
        {
            ...
            boDocGhi = new SqlDataAdapter(sql, ketNoi);
            dsAccount = new DataSet("DSFoodTable");
            boDocGhi.Fill(dsAccount, "FoodTable");
            dtgvAccount.DataSource = dsAccount.Tables["FoodTable"];
        } 
        ...
        private void dtgvTable_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtIDTable.Text = row.Cells["ID"].Value.ToString();
