...
namespace QLQuanCafe
{
    public partial class fAdmin : Form
    {
        ...
        private void LoadGridViewAccount()
        {
            ...
            dtgvTable.Columns["userName"].HeaderText = "Tên đăng nhập";
            dtgvTable.Columns["displayName"].HeaderText = "Tên hiển thị";
            dtgvTable.Columns["PassWord"].HeaderText = "Mật khẩu";
            dtgvTable.Columns["Type"].HeaderText = "Loại tài khoản";
        }
        ...
        private void LoadGridViewFoodTable()
        {
            ...
            {
                string sql = "SELECT tableID, tableName, tableStatus FROM FoodTable";
