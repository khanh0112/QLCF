    ...
    public partial class fTableManager : Form
    {
        ...
        void LoadEmptyTableToSwitch() // load bàn trống vào combobox chuyển bàn
        {
            ...
            using (SqlConnection conn = new SqlConnection(connection_string_sql))
            {
                ...
                cbSwitchTable0.DataSource = dt;
                cbSwitchTable0.DisplayMember = "tableName";
                cbSwitchTable0.ValueMember = "tableID";
            }

            cbSwitchTable0.SelectedIndex = 0;
        }
        ...
        private void btnSwitchTable_Click(object sender, EventArgs e) // chuyển bàn
        {
            ...
            if (cbSwitchTable0.SelectedValue == null || !(cbSwitchTable0.SelectedValue is int)) return; // không chọn bàn chuyển

            int newTableID = (int)cbSwitchTable0.SelectedValue;
