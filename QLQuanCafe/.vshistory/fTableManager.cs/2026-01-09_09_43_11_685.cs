...
namespace QLQuanCafe
{
    public partial class fTableManager : Form
    {
        ...
        private void cbCategory_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cbCategory.SelectedValue is not int cateID) return;
        ...
        private void btnAddFood_Click(object sender, EventArgs e)
        {
            ...
            if (flpTable.Controls.Count == 0) return;
            ...
            Button btn = flpTable.Controls
                .OfType<Button>()
                .FirstOrDefault(b => b.BackColor == Color.LightGray || b.BackColor == Color.LightGreen);

            if (btn == null) return;

            int tableID = (int)btn.Tag;

            int billID = GetOrCreateBill(tableID);

            AddOrUpdateBillInfo(billID, foodID, quantity);

            LoadBillByTable(tableID);
            LoadTable(); // refresh trạng thái bàn
        }
